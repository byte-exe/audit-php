...
<div id="halaman_awal">
	<h2 style="font-weight: bold;text-align: center;padding-top: 10px;font-size: 50px; font-family: arial black">FORM RESPONDEN</h2>
	<nav class="navbar navbar-default">
		<ul  class="nav navbar-nav" style="margin-left: 300px;margin-top: 5px;">
			<a href="index.php?halaman=input_nilai" class="btn btn-primary">Input Nilai</a>
